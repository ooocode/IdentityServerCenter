...
namespace IdentityServerCenter.Database.Services.DefaultImpl
{
    public class RoleService : ServiceBase, IRoleService
    {
        ...
        private readonly ApplicationRoleValidator applicationRoleValidator;

        public RoleService(RoleManager<ApplicationRole> roleManager,
            ApplicationDbContext applicationDbContext,
            ApplicationRoleValidator applicationRoleValidator)
        {
            ...
            this.applicationRoleValidator = applicationRoleValidator ?? throw new ArgumentNullException(nameof(applicationRoleValidator));
        }
